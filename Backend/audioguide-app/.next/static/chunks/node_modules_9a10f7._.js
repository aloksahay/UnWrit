(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_9a10f7._.js", {
...
"[project]/node_modules/@virtuals-protocol/game/dist/index.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var GameClient = class {
    ...
    getAccessToken() {
        return __async(this, null, function*() {
            const result = yield __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("https://api.virtuals.io/api/accesses/tokens", {}, {
                headers: {
        ...
        return __async(this, null, function*() {
            ...
            switch(action.action_type){
                ...
                case "continue_function" /* ContinueFunction */ :
                    verbose && this.log(`Performing function ${action.action_args.fn_name} with args ${JSON.stringify(action.action_args.args)}.`);
                    const fn = worker.functions.find((fn2)=>fn2.name === action.action_args.fn_name);
                    if (!fn) {
    ...
    run(heartbeatSeconds, options) {
        return __async(this, null, function*() {
            ...
            while(true){
                ...
                yield new Promise((resolve)=>setTimeout(resolve, heartbeatSeconds * 1e3));
            }
        });
    }
    save() {
...
var GameWorker = class {
    ...
    step(submissionId, options) {
        return __async(this, null, function*() {
            ...
            const fn = this.functions.find((fn2)=>fn2.name === action.action_args.fn_name);
            if (!fn) {
                throw new Error("Function not found");
            }
            (options == null ? void 0 : options.verbose) && ((_b = this.logger) == null ? void 0 : _b.call(this, `Performing function ${action.action_args.fn_name} with args ${JSON.stringify(action.action_args.args)}.`));
...
//# sourceMappingURL=node_modules_9a10f7._.js.map